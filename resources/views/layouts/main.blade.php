...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <form class="form-inline" action="{{route('blog')}}">
                        <input class="form-control mr-sm-2" type="search" name="q" value="{{!empty(request()->q) ? request()->q:''}}" placeholder="Search" aria-label="Search">
        ...
        <footer class="footer">
            <p class="text-center">Copyright {{date('d.m.Y')}} @ powerd by Norayr Petrosyan</p>
        </footer>
