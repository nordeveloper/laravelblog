        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <textarea name="preview_text" class="form-control textarea" cols="30" rows="6">{{old('preview_text')}}</textarea>
                </div>           
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <textarea name="detail_text" class="form-control textarea" cols="30" rows="6">{{old('detail_text')}}</textarea>
                </div>
